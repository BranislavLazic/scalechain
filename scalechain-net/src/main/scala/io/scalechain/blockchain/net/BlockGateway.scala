...
class BlockGateway {
  ...
  val ConsensualBlockHeaderCache = new TimeBasedCache[Hash, BlockHeader](5, TimeUnit.MINUTES)

  val ReceivedBlockCache = new TimeBasedCache[Hash, Block](5, TimeUnit.MINUTES)
