...
import io.scalechain.blockchain.api.command.blockchain.{ GetBlock, GetBlockResult }
...
@Ignore
class GetBlockSpec extends AnyFlatSpec with BeforeAndAfterEach with APITestSuite {
  this: Suite =>
