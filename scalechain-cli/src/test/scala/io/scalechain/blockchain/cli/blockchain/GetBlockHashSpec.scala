...
import io.scalechain.blockchain.api.command.blockchain.{ GetBestBlockHash, GetBlock, GetBlockHash }
...
@Ignore
class GetBlockHashSpec extends AnyFlatSpec with BeforeAndAfterEach with APITestSuite {
  this: Suite =>
