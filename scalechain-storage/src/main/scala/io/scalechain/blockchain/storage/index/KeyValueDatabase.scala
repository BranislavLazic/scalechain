...
import io.scalechain.blockchain.proto.codec.primitive.{ CString, CStringPrefixed, CStringPrefixedCodec }
...
trait KeyValueDatabase {
  ...
  def seekObject[V <: ProtocolMessage](
      rawKeyOption: Option[Array[Byte]] = None
  )(implicit valueCodec: MessagePartCodec[V]): ClosableIterator[(Array[Byte], V)] = {
    class ValueMappedIterator(iterator: ClosableIterator[(Array[Byte], Array[Byte])])
        extends ClosableIterator[(Array[Byte], V)] {
  ...
  def seekObject[K <: ProtocolMessage, V <: ProtocolMessage](prefix: Byte, key: K)(implicit
      keyCodec: MessagePartCodec[K],
      valueCodec: MessagePartCodec[V]
  ): ClosableIterator[(K, V)] =
    seekObjectInternal(Array(prefix), Some(key))(keyCodec, valueCodec)

  def seekPrefixedObject[K <: ProtocolMessage, V <: ProtocolMessage](prefix: Byte, keyPrefix: String)(implicit
      keyCodec: MessagePartCodec[K],
      valueCodec: MessagePartCodec[V]
  ): ClosableIterator[(CStringPrefixed[K], V)] =
    seekObjectInternal(prefixedKey(prefix, CString.serialize(keyPrefix)), None)(
      new CStringPrefixedCodec(keyCodec),
      valueCodec
    )

  def seekPrefixedObject[K <: ProtocolMessage, V <: ProtocolMessage](prefix: Byte)(implicit
      keyCodec: MessagePartCodec[K],
      valueCodec: MessagePartCodec[V]
  ): ClosableIterator[(CStringPrefixed[K], V)] =
    seekObjectInternal(Array(prefix), None)(new CStringPrefixedCodec(keyCodec), valueCodec)

  protected def seekObjectInternal[K <: ProtocolMessage, V <: ProtocolMessage](
      prefix: Array[Byte],
      keyOption: Option[K]
  )(keyCodec: MessagePartCodec[K], valueCodec: MessagePartCodec[V]): ClosableIterator[(K, V)] = {
  ...
  def getObject[K <: ProtocolMessage, V <: ProtocolMessage](prefix: Byte, key: K)(implicit
      keyCodec: MessagePartCodec[K],
      valueCodec: MessagePartCodec[V]
  ): Option[V] = {
  ...
  def getPrefixedObject[K <: ProtocolMessage, V <: ProtocolMessage](prefix: Byte, keyPrefix: String, key: K)(implicit
      keyCodec: MessagePartCodec[K],
      valueCodec: MessagePartCodec[V]
  ): Option[V] = {
  ...
  def putObject[K <: ProtocolMessage, V <: ProtocolMessage](prefix: Byte, key: K, value: V)(implicit
      keyCodec: MessagePartCodec[K],
      valueCodec: MessagePartCodec[V]
  ): Unit = {
    val rawKey = prefixedKey(prefix, keyCodec.serialize(key))
  ...
  def putPrefixedObject[K <: ProtocolMessage, V <: ProtocolMessage](prefix: Byte, keyPrefix: String, key: K, value: V)(
      implicit
      keyCodec: MessagePartCodec[K],
      valueCodec: MessagePartCodec[V]
  ): Unit = {
  ...
  def delPrefixedObject[K <: ProtocolMessage](prefix: Byte, keyPrefix: String, key: K)(implicit
      keyCodec: MessagePartCodec[K]
  ): Unit =
    delPrefixedObject(prefix, CStringPrefixed(keyPrefix, key))

  def delPrefixedObject[K <: ProtocolMessage](prefix: Byte, key: CStringPrefixed[K])(implicit
      keyCodec: MessagePartCodec[K]
  ): Unit = {
