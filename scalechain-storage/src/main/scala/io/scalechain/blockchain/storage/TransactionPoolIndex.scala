...
import io.scalechain.blockchain.proto.codec.{ HashCodec, OneByteCodec, TransactionCodec, TransactionPoolEntryCodec }
import io.scalechain.blockchain.proto.{ Hash, OneByte, Transaction, TransactionPoolEntry }
...
trait TransactionPoolIndex {
  ...
  /** Put a transaction into the transaction pool.
    ...
    */
  def putTransactionToPool(txHash: Hash, transactionPoolEntry: TransactionPoolEntry)(implicit
      db: KeyValueDatabase
  ): Unit =
