...
import io.scalechain.blockchain.proto.{ Hash, TransactionDescriptor }
import io.scalechain.blockchain.proto.codec.{ HashCodec, TransactionDescriptorCodec, TransactionPoolEntryCodec }
...
trait TransactionDescriptorIndex {
  ...
  /**
    ...
    */
  def putTransactionDescriptor(txHash: Hash, transactionDescriptor: TransactionDescriptor)(implicit
      db: KeyValueDatabase
  ) =
