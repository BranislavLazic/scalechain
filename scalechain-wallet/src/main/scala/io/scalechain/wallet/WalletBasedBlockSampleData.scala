...
import io.scalechain.blockchain.transaction.{ CoinAddress, ParsedPubKeyScript, PrivateKey, PublicKey }

class WalletBasedBlockSampleData(wallet: Wallet)(implicit override val db: KeyValueDatabase)
    extends BlockSampleData()(db) {
